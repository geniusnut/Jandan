...
public class FloatingActionButton1 extends View {
	...
	public static class Builder {
		...
		int gravity = Gravity.BOTTOM | Gravity.LEFT; // default bottom right
		Drawable drawable;
		 ...
		 */
		public FloatingActionButton1 create() {
			final FloatingActionButton1 button = new FloatingActionButton1(activity);
