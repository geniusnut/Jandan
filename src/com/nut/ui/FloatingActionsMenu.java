...
public class FloatingActionsMenu extends ViewGroup {
	...
	public static Drawable createLikeDrawable(Context context, boolean clicked) {
		...
		return SVG.getDrawable(res, clicked ? R.raw.ic_favorite : R.raw.ic_favorite_outline, context.getResources().getColor(android.R.color.holo_blue_light), size);
	}
